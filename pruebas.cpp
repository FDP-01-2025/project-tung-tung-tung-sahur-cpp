...
getch();
if (answer == "dinero" || answer == "Dinero")
{
...
string PlayerWinner;
string money[2][2] {"Te quedas con $10000000000000", "Has donado $5000000000000 a la caridad", 
"Le perdonaste la vida a los demas jugadores pero tu premio se redujo a una tercera parte", "Los demas jugadores han muerto y te quedas todo el dinero"};
                    int opca, opcb;

if (SecondPlayerScore >= 10 && FirstPlayerScore >= 10)
{
...
if (SecondPlayerScore >= 10)
{
    ...
    PlayerWinner = SecondPlayerName;
}
else
{    cout<<FirstPlayerName<<" ha ganado el juego";
    PlayerWinner = FirstPlayerName;}

if (SecondPlayerScore < 10 or FirstPlayerScore < 10)
{
    cout<<endl<<"¿Que quieres hacer con el dinero?"<<endl;
    cout<<"1- Quedarte el dinero"<<endl;
    cout<<"2- Donar la mitad del dinero a caridad"<< endl;
    cin>>opca;
    cout<<endl<<"Ahora decide el destino de tus adversarios"<<endl;
    cout<<"1- Perdonarles la vida pero quedarte la mitad del dinero"<< endl;
    cout<<"2- Dejarlos morir"<<endl;
    cin>>opcb;
    opca--;
    opcb--;
    if (opca == 0 || opca == 1 && opcb == 0 || opcb == 1)
    {
        string enda = money[0][opca];
        string endb = money[1][opcb];
        cout<<endl<<enda<<" y "<<endb<<endl;}
    }
...
if (SecondPlayerScore >= 10 && FirstPlayerScore >= 10 || ThirdPlayerScore >= 1 && FirstPlayerScore >= 10 || ThirdPlayerScore >= 10 && SecondPlayerScore >= 10) 
{
    cout<<"Hubo un empate";
}
...
if (SecondPlayerScore < 10 && FirstPlayerScore < 10 || ThirdPlayerScore < 10 && FirstPlayerScore < 10 || ThirdPlayerScore < 10 && SecondPlayerScore < 10)
{
    cout<<endl<<"¿Que quieres hacer con el dinero?"<<endl;
    cout<<"1- Quedarte el dinero"<<endl;
    cout<<"2- Donar la mitad del dinero a caridad"<< endl;
    cin>>opca;
    cout<<endl<<"Ahora decide el destino de tus adversarios"<<endl;
    cout<<"1- Perdonarles la vida pero quedarte la tercera parte del dinero"<< endl;
    cout<<"2- Dejarlos morir"<<endl;
    cin>>opcb;
    opca--;
    opcb--;
